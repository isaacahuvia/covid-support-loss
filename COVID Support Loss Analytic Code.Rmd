...
clean <- raw %>%
  ...
  mutate(
    ...
    ethnicity = case_when(race == 1 & hispanic == 0 ~ "White non-Hispanic",
                          ...
                          race == 5 & hispanic == 0 ~ "NHOPI non-Hispanic",
...
out$p[!is.na(out$p)] <- p.adjust(out$p[!is.na(out$p)], "holm") 
